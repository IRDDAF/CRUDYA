    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Preguntas Frecuentes <b>FAADPRO</b></h2></div>
                    <div class="col-sm-4">
                        <a href='./insertar/insertarpf.html' class="btn btn-info add-new"><i class="fa fa-plus"></i> Añadir Preguntas Frecuentes</a>
                    </div>
                </div>
            </div>
            <?php
...
$sql = "SELECT id, pregunta, respuesta FROM preguntasfrecuentes";
...
if ($result->num_rows > 0) {
  ...
  echo "<tr>";
  echo "<th>No.pregunta</th><th>Pregunta</th><th>Respuesta</th><th>acciones</th>";
  echo "</tr>";
  while($row = $result->fetch_assoc()) {
            echo "<tr>";
            echo "<td>".$row["id"]."</td><td>".$row["pregunta"]."</td><td>".$row["respuesta"]."</td>";
            echo "<td>
            <a class='edit' title='Editar' data-toggle='tooltip' href='./modificar/formmodpf.php?id=".$row["id"]."&pregunta=".$row["pregunta"]."&respuesta=".$row["respuesta"]."' ><i class='material-icons'>&#xE254;</i></a>
            <a class='delete' title='Eliminar' data-toggle='tooltip' href='./eliminar/eliminarpf.php?id=".$row["id"]."' ><i class='material-icons'>&#xE872;</i></a>
        </td>";
            echo "</tr>";
  }
} else {
