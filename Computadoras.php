...
<nav class="menu">
        ...
        <ol class='menu__content'>
          ...
          <li class="menu-item"><a href="./Empleados.php">Empleados</a></li>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Computadoras <b>FAADPRO</b></h2></div>
                    <div class="col-sm-4">
                        <a href='./insertar/insertarco.html'  class="btn btn-info add-new"><i class="fa fa-plus"></i> Añadir Computadoras</a>
                    </div>
                </div>
            </div>
            <?php
...
$sql = "SELECT id, modelo, sistemaoperativo, costo, garantia FROM computadoras";
...
if ($result->num_rows > 0) {
  ...
  echo "<tr>";
  echo "<th>ID</th><th>modelo</th><th>soperativo</th><th>costo</th><th>garantia</th><th>acciones</th>";
  echo "</tr>";
  while($row = $result->fetch_assoc()) {
            echo "<tr>";
            echo "<td>".$row["id"]."</td><td>".$row["modelo"]."</td><td>".$row["sistemaoperativo"]."</td><td>$".$row["costo"]."</td><td>".$row["garantia"]."</td>";
            echo "<td>
            <a class='edit' title='Editar' data-toggle='tooltip' href='./modificar/formmodcomputadoras.php?id=".$row["id"]."&modelo=".$row["modelo"]."&sistemaoperativo=".$row["sistemaoperativo"]."&costo=".$row["costo"]."&garantia=".$row["garantia"]."' ><i class='material-icons'>&#xE254;</i></a>
            <a class='delete' title='Eliminar' data-toggle='tooltip' href='./eliminar/eliminarco.php?id=".$row["id"]."' ><i class='material-icons'>&#xE872;</i></a>
        </td>";
            echo "</tr>";
  }
} else {
