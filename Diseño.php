    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Diseño <b>FAADPRO</b></h2></div>
                    <div class="col-sm-4">
                        <a href='./insertar/insertard.html' class="btn btn-info add-new"><i class="fa fa-plus"></i> Añadir Diseño</a>
                    </div>
                </div>
            </div>
            <?php
...
$sql = "SELECT id, modelo, tipos, caracteristicas FROM diseño";
...
if ($result->num_rows > 0) {
  ...
  echo "<tr>";
  echo "<th>ID</th><th>modelo</th><th>tipos</th><th>caracteristicas</th><th>acciones</th>";
  echo "</tr>";
  while($row = $result->fetch_assoc()) {
            echo "<tr>";
            echo "<td>".$row["id"]."</td><td>".$row["modelo"]."</td><td>".$row["tipos"]."</td><td>".$row["caracteristicas"]."</td>";
            echo "<td>
            <a class='edit' title='Editar' data-toggle='tooltip' href='./modificar/formmoddiseño.php?id=".$row["id"]."&modelo=".$row["modelo"]."&tipos=".$row["tipos"]."&caracteristicas=".$row["caracteristicas"]."' ><i class='material-icons'>&#xE254;</i></a>
            <a class='delete' title='Eliminar' data-toggle='tooltip' href='./eliminar/eliminard.php?id=".$row["id"]."' ><i class='material-icons'>&#xE872;</i></a>
        </td>";
            echo "</tr>";
  }
} else {
